        ...
        <div className=" no-scrollbar flex-1 h-[95vh] overflow-y-scroll flex flex-col justify-center">
            <form onSubmit={onSubmitHandler} className="md:p-10 p-4 space-y-5 max-w-lg">
                ...
                <div className="flex flex-col gap-1 max-w-md">
                    ...
                    <input onChange={(e)=>setFiles(e.target.value)} value={name} id="product-name" type="text" placeholder="Type here" className="outline-none md:py-2.5 py-2 px-3 rounded border border-gray-500/40" required />
                </div>
                <div className="flex flex-col gap-1 max-w-md">
